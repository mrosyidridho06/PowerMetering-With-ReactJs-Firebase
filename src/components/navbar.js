            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center">
                ...
                <div className="hidden md:block">
                  <div className="flex ml-60 items-end">
                    <Link to="/dashboard">
                      <a className=" hover:bg-gray-700 text-white px-3 py-2 rounded-md text-sm font-medium"> Dashboard </a>
                    </Link>
